...
### Code Validation
* HTML - No errors or warnings were detected by [W3C](https://validator.w3.org/#validate_by_input) for pages:
...
* Hidden aria was removed from the Github icon:
